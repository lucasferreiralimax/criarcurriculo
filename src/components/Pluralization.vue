...
label.btn.pluralization(for="locale" :class="{ 'active' : isLocale}")
  transition(name="fade")
    select#locale(v-model="locale" v-if="isLocale")
      ...
      option(value="fr") {{ $t('locale.fr')}}
      option(value="tr") {{ $t('locale.tr')}}
      option(value="ch") {{ $t('locale.ch')}}
      option(value="de") {{ $t('locale.de')}}
      option(value="it") {{ $t('locale.it')}}
      option(value="gr") {{ $t('locale.gr')}}
      option(value="tl") {{ $t('locale.tl')}}
  button.icon#pluralization(@click="openPluralization" role="button" type="button" :aria-label="$t('aria-label.pluralization')")
