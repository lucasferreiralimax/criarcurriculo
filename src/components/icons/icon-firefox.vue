<template>
<svg xmlns='http://www.w3.org/2000/svg' data-name='Firefox - Large' viewBox='0 0 1024 1024'>
  <defs>
    <radialGradient id='firefox-a' cx='-14480.522' cy='-8329.079' r='450.875' fx='-14509.281' gradientTransform='matrix(.762 .034 -.05 1.12 11560.893 10069.103)' gradientUnits='userSpaceOnUse'>
    ...
    <radialGradient id='firefox-b' cx='-7529.669' cy='-7921.608' r='791.229' gradientTransform='translate(9921.963 9899.103) scale(1.225)' gradientUnits='userSpaceOnUse'>
    ...
    <radialGradient id='firefox-d' cx='-8260.94' cy='-6516.556' r='266.886' gradientTransform='rotate(5.67 -90364.99 106952.151) scale(1.225)' gradientUnits='userSpaceOnUse'>
      <stop offset='.003' stop-color='#ffea00'/>
      <stop offset='.497' stop-color='#ff272d'/>
      <stop offset='1' stop-color='#c42482'/>
    </radialGradient>
    <radialGradient id='firefox-e' cx='-8285.087' cy='-6772.468' r='445.678' gradientTransform='rotate(5.67 -90364.99 106952.151) scale(1.225)' gradientUnits='userSpaceOnUse'>
    ...
    <radialGradient id='firefox-f' cx='-8222.051' cy='-6359.332' r='408.958' gradientTransform='rotate(5.67 -90364.99 106952.151) scale(1.225)' gradientUnits='userSpaceOnUse'>
      <stop offset='.003' stop-color='#ff272d'/>
      <stop offset='.497' stop-color='#c42482'/>
      <stop offset='.986' stop-color='#620700'/>
    </radialGradient>
    <radialGradient id='firefox-g' cx='750.189' cy='396.041' r='782.18' fx='778.167' fy='382.212' gradientUnits='userSpaceOnUse'>
    ...
    <radialGradient id='firefox-h' cx='691.339' cy='3.289' r='923.615' gradientUnits='userSpaceOnUse'>
    ...
    <linearGradient id='firefox-c' x1='575.669' x2='384.231' y1='731.188' y2='104.96' gradientUnits='userSpaceOnUse'>
      <stop offset='0' stop-color='#000f43' stop-opacity='.4'/>
      <stop offset='.485' stop-color='#001962' stop-opacity='.173'/>
      <stop offset='1' stop-color='#002079' stop-opacity='0'/>
    </linearGradient>
    <linearGradient id='firefox-i' x1='-8944.65' x2='-8660.289' y1='-6677.742' y2='-6750.226' gradientTransform='rotate(5.67 -90364.99 106952.151) scale(1.225)' gradientUnits='userSpaceOnUse'>
    ...
    <linearGradient id='firefox-j' x1='245.347' x2='190.775' y1='-1082.012' y2='-1221.859' gradientTransform='rotate(5.73 -13193.275 -1077.296)' gradientUnits='userSpaceOnUse'>
      <stop offset='0' stop-color='#891551' stop-opacity='.6'/>
      <stop offset='1' stop-color='#c42482' stop-opacity='0'/>
    </linearGradient>
    <linearGradient id='firefox-k' x1='22.04' x2='116.148' y1='718.827' y2='825.714' gradientTransform='rotate(5.73 2610.902 2923.845)' gradientUnits='userSpaceOnUse'>
      <stop offset='.005' stop-color='#891551' stop-opacity='.5'/>
      <stop offset='.484' stop-color='#ff272d' stop-opacity='.5'/>
      <stop offset='1' stop-color='#ff272d' stop-opacity='0'/>
    </linearGradient>
    <linearGradient id='firefox-l' x1='200.104' x2='200.171' y1='904.616' y2='829.835' gradientTransform='rotate(5.73 2610.902 2923.845)' gradientUnits='userSpaceOnUse'>
    ...
    <linearGradient id='firefox-m' x1='655.531' x2='961.187' y1='38.12' y2='721.615' gradientUnits='userSpaceOnUse'>
    ...
    <linearGradient id='firefox-n' x1='715.885' x2='571.098' y1='431.21' y2='819.96' gradientUnits='userSpaceOnUse'>
  ...
  <path fill='url(#firefox-a)' d='M805.285 93.558c-23.947 27.884-35.1 90.639-10.818 154.256s61.5 49.8 84.7 114.673c30.623 85.6 16.369 200.589 16.369 200.589s36.814 106.609 62.468-6.633c56.783-212.703-152.719-410.506-152.719-462.885z'/>
  <path fill='url(#firefox-b)' d='M513.072 976.638c245.236 0 443.9-199.739 443.9-446.028S758.308 84.583 513.31 84.583 69.65 284.322 69.65 530.61c-.475 246.527 198.423 446.028 443.422 446.028z' data-name='&lt;Path&gt;'/>
