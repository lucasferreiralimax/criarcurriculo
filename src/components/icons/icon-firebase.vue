<template lang="pug">
svg.icon-firebase(width="45" viewBox="0 0 256 351" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid")
  defs
...
<script>
export default { name: 'icon-firebase' }
</script>
