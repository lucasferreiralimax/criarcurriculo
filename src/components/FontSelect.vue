<template lang="pug">
label.btn.fontSelect(for="fonttype" :class="{ 'active' : isFontSelect}")
  transition(name="fade")
    select#fonttype(v-model="fonttype" v-if="isFontSelect")
      option(value="normal") normal
      option(value="abel") abel
      option(value="cinzel") cinzel
      option(value="kaushan") kaushan
      option(value="rajdhani") rajdhani
  button.icon#fontSelect(@click="openFontSelect" role="button" type="button" :aria-label="$t('aria-label.font_select')")
