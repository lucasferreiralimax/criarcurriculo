<template lang="pug">
  button.btn.icon-render(@click="iconToggle" role="button" type="button" :aria-label="$t('aria-label.theme')")
  ...
  methods: {
    iconRender () {
      ...
      if(this.iconShow) {
        ...
        console.log('icon render', render)
        console.log('icon render', this.iconShow)
      } else {
