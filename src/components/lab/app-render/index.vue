    ...
    .content(:class="layout_render")
      ...
      .info(:class="{ 'photo': user.photo }" v-if="user.name || user.maritalstatus")
        label(for="GET-name")
          h1 {{ user.name }}
        .contacts
          p.contact-information(v-if="user.maritalstatus")
          ...
          p.contact-information(v-if="user.end.logradouro || user.end.localidade || user.end.uf" @click="labelFor('GET-address')")
