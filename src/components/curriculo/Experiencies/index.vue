...
draggable(:list="user.exps"
  ...
  box(v-if="user.exps.length !== 0"
    ...
    .row
      text-area-app(:index="key" :name="'expsabout-' + key" :value="{ parent: 'exps', child: 'experience' }" translate="activities" vuex="updateExp")
    .row
      input-app(:index="key" :name="'companyLink-' + key" :value="{ parent: 'exps', child: 'experience', content: 'link' }" type="text" translate="link" vuex="updateExp")
  box
