<template lang="pug">
  section.mark.text-center
    ...
    el-carousel.carousel(:interval="5000" type="card")
      el-carousel-item.carousel-item.github
        svg(width="60" viewBox="0 0 256 250" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid")
        ...
        h2
          a(href='https://github.com/lucasferreiralimax/criarcurriculo' target='_blank' rel="noopener")
            | {{ $t('view.about.slide1') }}
      el-carousel-item.carousel-item.help
        h2 {{ $t('view.about.slide2') }}
      el-carousel-item.carousel-item.colab
...
<script>
import Hitech from '@/components/Hitech'
