<template lang="pug">
  section.home.content
    hooper.mark(:autoPlay="true" :infiniteScroll="true")
      ...
      slide(:index='1').center.github
        h2 {{ $t('view.about.slide2') }}
          iframe.facebook(src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fcurriculonovo&width=233&layout=button_count&action=like&size=large&share=true&height=46&appId" width="233" height="46" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share")
      slide(:index='2').center.help
        svg(width="100" viewBox="0 0 512.001 512.001" xmlns="http://www.w3.org/2000/svg")
        ...
        h2 {{ $t('view.about.slide3') }}
        iframe.facebook(src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fcurriculonovo&width=110&layout=box_count&action=like&size=large&share=false&height=65&appId" width="110" height="65" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share")
  ...
  .hooper-slide
    ...
    &.github
      ...
      path
        fill #fff
    &.help
      background-image url('../assets/bg-rosa.jpg')
      svg
        fill #fff
        margin-bottom 2em
        animation world 7s infinite linear
  .mark
    display flex
    justify-content center
    align-items center
