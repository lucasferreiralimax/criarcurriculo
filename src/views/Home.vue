  ...
  section.home.content
    hooper.mark(:autoPlay="true" :infiniteScroll="true")
      ...
      slide(:index='2').center.help
        ...
        iframe.facebook(
          src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2Fcurriculonovo&width=110&layout=box_count&action=like&size=large&share=false&height=65&appId"
          width="80"
          height="65"
          scrolling="no"
          frameborder="0"
